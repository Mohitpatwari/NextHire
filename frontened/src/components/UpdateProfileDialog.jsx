          ...
          <form onSubmit={submitHandler}>
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input id="name" name="name" value={input.fullname} onChange={changeEventHandler} type="text" className="col-span-3" />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
            ...
            <DialogFooter>
            {
            loading? <Button className="w-full my-4 bg-blue-950 text-white"><Loader2 className="mr-2 h-4 w-4 animate-spin"/>Please wait</Button> :
            <Button className="w-full my-4 bg-blue-950 text-white" type="submit">
            Update
          </Button>
          }
            </DialogFooter>
