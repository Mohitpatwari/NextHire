...
const Companycreate = () => {
   ...
   const registerNewCompany=async () => {
    try{
     ...
     console.log("Failed to register for new company",error)
    ...
    <div>
        ...
        <div className='max-w-4xl mx-auto'>
            ...
            <div className='flex items-center gap-2 my-10'>
                ...
                <Button onClick={()=>registerNewCompany()} className=" bg-blue-950 text-white hover:bg-blue-900">Continue</Button>
            </div>
        </div>
    </div>
  )
